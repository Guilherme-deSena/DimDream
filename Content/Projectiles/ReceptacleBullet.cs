...
{
    internal class ReceptacleBullet : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            // Revert direction after certain amount of frames if the NPC that creates this bullet tells so
            if (Behavior == 1f && Projectile.timeLeft == 620)
            {
