...
{
    public class OrinBagCat : ModItem
    {
        ...
        {
            itemLoot.Add(ItemDropRule.OneFromOptions(1, [ModContent.ItemType<BarrowsWheel>(), ModContent.ItemType<VengefulSpiritStaff>()]));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<OrinsCartEnabled>(), 4));
            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<OrinBossCat>()));
        }
    }
}